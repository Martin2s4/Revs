...
export default function App() {
  ...
  const renderView = () => {
    switch (activeView) {
      ...
      case "payments":
        return <Payments user={user} setActiveView={setActiveView} />;
      case "collection":
        return <FieldCollection setActiveView={setActiveView} />;
      case "licenses":
        return <Licenses user={user} setActiveView={setActiveView} />;
      case "reports":
        return <Reports />;
      case "citizens":
        return <Citizens setActiveView={setActiveView} />;
      case "departments":
